...
namespace RefactoringSample1.Tests
{
	...
	public class CustomerTest
	{
		...
		/// <summary>
		/// Test that customer statement is correct
		/// </summary>
		/// <param name="rental1">Rental object</param>
		/// <param name="rental2">Rental object</param>
		/// <param name="totalAmt">Correct total charge of rental1 and rental2</param>
		/// <param name="freqPoints">Correct obtained frequent renter points from rental1 and rental2</param>
		[Theory]
		...
		public static TheoryData<Rental, Rental, double, int> RentalTestData()
		{
			return new TheoryData<Rental, Rental, double, int> {
				...
				{ new Rental(_movies[1], 5), new Rental(_movies[0], 1), 16.5, 3},
			};
		}
	}
}